...
## From Active Monitoring to Peripheral Awareness
...
2. **Transparency paradox**: People often say they want full visibility but in practice prefer only what matters. Calibrating this per user is an ongoing design challenge.
3. **Modality matching**: Signals must work at a desk, on a phone, in a meeting, on a factory floor, in a car.
4. **Confidence through quiet**: Silence must feel reassuring, not worrying. See [Trust Building](/design-principles/trust-building) for how silence relates to trust stages.

> For how ambient signals feed into a unified view, see [The Command Center](/experience-design/command-center). For how urgency and confidence affect what requires explicit approval, see [Coordination Zones](/experience-design/coordination-zones).
