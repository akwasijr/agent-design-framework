...
Humans interact with agents through three modes, often switching between them.
...
> These three modes map to how visible the agent should be. [Coordination Zones](/experience-design/coordination-zones) explores this visibility dimension in depth: *done with me* (collaborate), *done for me* (supervise), and *done under me* (delegate). The modes describe **what the human does**; the zones describe **how present the agent feels**.
