...
Agents are not just backend logic: they are products with their own design requirements. How should an agent be designed as an entity?
...
Agents need a designed personality: not to be human, but to be **consistent and appropriate**.
